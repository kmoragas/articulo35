...
;(function Preview_Elements_Generic_Scope() {
    ...
    var Preview_Elements_Generic = new Class({
        ...
        animate: function(pElement, pAnimation, pProps) {
            var map = {
                null: Power0.easeNone,
                'linear': Power0.easeNone,
                'ease-in': Power2.easeIn,
                'ease-out': Power2.easeOut,
                'ease-in-out': Power2.easeInOut,
                'back-out': Back.easeOut,
                'elastic-out': Elastic.easeOut.config(1, 0.35)
            };
            ...
            TweenLite.to(pElement, pAnimation && pAnimation.style !== '' ? pAnimation.time / 1000 : 0, _.defaults(_.omit(pProps, function(value) {
                return value === null;
            }), {
                ease: map[pAnimation && pAnimation.style ? pAnimation.style : null]
            }));
        },
        ...
        setStyle: function(pStyle, pValue, pUpdateOriginal, pAnimation) {
            ...
            var currentStyle = window.getComputedStyle(el)[styleProperty];
        ...
        rotate: function(pAngle, pType, pAnimation) {
            ...
            this.animate(this.getElement(), pAnimation, {
                rotation: type[pType] + parseInt(pAngle, 10)
            });
        },
...
;(function InteractionsAnimationsScope(global) {
  ...
  InteractionsAnimations.scroll = function(el, to, duration, timing) {
    ...
    var currentTime = 0;
    var increment = 20;
    var animationTiming = timing || 'linear';
    ...
    var animateScroll = function(){
      ...
      el.scrollTop = InteractionsAnimations.timing[animationTiming](currentTime, start, change, duration);
